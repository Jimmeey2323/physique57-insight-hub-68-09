...
export const AdvancedExportButton: React.FC<AdvancedExportButtonProps> = ({
  ...
  const handleExport = async () => {
    try {
      const exportData = {
        ...(selectedSections.sales && { salesData }),
        ...(selectedSections.sessions && { sessionsData }),
        ...(selectedSections.clientConversion && { newClientData }),
        ...(selectedSections.trainerPerformance && { payrollData }),
        ...(selectedSections.lateCancellations && { lateCancellationsData }),
        ...(selectedSections.discounts && { discountData }),
        ...(selectedSections.additional && { additionalData })
      };
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, sales: !!checked }))}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="sessions"
                  checked={selectedSections.sessions}
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, sessions: !!checked }))}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="clientConversion"
                  checked={selectedSections.clientConversion}
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, clientConversion: !!checked }))}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="trainerPerformance"
                  checked={selectedSections.trainerPerformance}
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, trainerPerformance: !!checked }))}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="lateCancellations"
                  checked={selectedSections.lateCancellations}
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, lateCancellations: !!checked }))}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  id="discounts"
                  checked={selectedSections.discounts}
                  onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, discounts: !!checked }))}
                />
              ...
              {Object.keys(additionalData).length > 0 && (
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="additional"
                    checked={selectedSections.additional}
                    onCheckedChange={(checked) => setSelectedSections(prev => ({ ...prev, additional: !!checked }))}
                  />
